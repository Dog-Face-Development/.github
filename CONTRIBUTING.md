...
The following is a set of guidelines for contributing to Dog Face Development Co.'s %PROGRAM NAME% project on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
- If you are creating a pull request on your own, read the [Individual CLA](%INDIVIDUAL CLA LINK%). If you are creating a pull request as part of your employment, read the [Entity CLA](%ENTITY CLA LINK%).
- Open a [pull request](%NEW GITHUB PR LINK%).
