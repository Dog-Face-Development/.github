...
- **Application** means the software program provided by Dog Face Development Company downloaded by you on any electronic device.
...
If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company. Contact information is available on the GitHub page.
